...
import com.spring.boot.microservices.currencyexchangeservice.repository.ExchangeValueRepository;
...
public class CurrencyExchangeController {
	...
	public ExchangeValue getCurrencyExchangeValue(@PathVariable String from, @PathVariable String to) {
		...
		ExchangeValue eValue = exchangeValueRepository.findByFromAndTo(from, to);
